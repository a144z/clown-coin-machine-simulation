...
def train_model(training_data, model=False):
    ...
    model.fit({'input':X}, {'targets':y}, n_epoch=10000, snapshot_step=500, show_metric=True, run_id='openaistuff2')
...
def test():
    ...
    print('Choice 1: {}, Choice 2: {}, Choice 3: {}, Choice 4: {}, Choice 5: {}, Choice 6: {}, Choice 7: {}, Choice 8: {}, Choice 9: {}'.format(choices.count(1)/len(choices),choices.count(2)/len(choices),choices.count(3)/len(choices),choices.count(4)/len(choices),choices.count(5)/len(choices),choices.count(6)/len(choices),choices.count(7)/len(choices),choices.count(8)/len(choices),choices.count(9)/len(choices)))
#test()
